...
I am building a virtualized lab environment using **Hyper-V** and **Windows 10 Pro** to bridge the gap between theory and practice. 
This project serves as a hands-on application of the networking and security principles I’ve studied through **CompTIA Network+**, **Security+**, and **TryHackMe** labs.
